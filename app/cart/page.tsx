...
import { applyCoupon, decrementItem, incrementItem, toggleItem, undo } from '@/redux/Slices/grocerySlice';
import { useAppSelector } from '@/redux/store/store';
import { ArrowLeft, CheckCircle2, Minus, Plus, ShoppingCart, Tag, Trash2, Undo2 } from 'lucide-react';
      ...
      <header className="sticky top-0 z-50 backdrop-blur-lg bg-white/80 dark:bg-gray-900/80 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center gap-3">
            ...
            <h1 className=" text-slate-900 text-2xl md:text-3xl font-bold   bg-clip-text ">
              Your Cart
            </h1>
          </div>
        </div>
              ...
              <CardContent>
                {items.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {items.map((item: any) => (
                      <div key={item.id} className="flex items-center gap-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:shadow-md transition-shadow">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      className="uppercase"
                    />
                    <Button onClick={handleApplyCoupon} className=' cursor-pointer' variant="default">
                      Apply
                    </Button>
                  </div>
                  {showSuccess && coupon && (
                  ...
                  <div className="flex flex-wrap gap-2">
                    <Badge variant="outline" className="text-xs">SAVE10 - 10% off</Badge>
                    <Badge variant="outline" className="text-xs">SAVE20 - 20% off</Badge>
                    <Badge variant="outline" className="text-xs">SAVE30 - 30% off</Badge>
                  </div>
                </div>
